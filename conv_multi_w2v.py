...
def build_cnn(sens,sen_length, W_embed_top, W_embed_bot,dim_top,dim_bot,h_top,h_bot,class_num,batch_size):
    ...
    l_top_pool1=lasagne.layers.MaxPool2DLayer(l_top_conv1, pool_size=(sen_length-filter_height[0]+1, 1))
    l_top_pool2=lasagne.layers.MaxPool2DLayer(l_top_conv2, pool_size=(sen_length-filter_height[1]+1, 1))
    l_top_pool3=lasagne.layers.MaxPool2DLayer(l_top_conv3, pool_size=(sen_length-filter_height[2]+1, 1))
    ...
    l_bot_pool1=lasagne.layers.MaxPool2DLayer(l_bot_conv1, pool_size=(sen_length-filter_height[0]+1, 1))
    l_bot_pool2=lasagne.layers.MaxPool2DLayer(l_bot_conv2, pool_size=(sen_length-filter_height[1]+1, 1))
    l_bot_pool3=lasagne.layers.MaxPool2DLayer(l_bot_conv3, pool_size=(sen_length-filter_height[2]+1, 1))
    
    #merge
    all_layers=[l_top_pool1,l_top_pool2,l_top_pool3,l_bot_pool1,l_bot_pool2,l_bot_pool3]
